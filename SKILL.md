...
2. **Route only if needed.**
   ...
   - One worker default. In-session for small, non-isolable, live-steering, or dirty mid-task work.
   - Never Hermes `delegate_task` as a substitute. Invoke live `smart-subagents.sh` for isolable labor.
